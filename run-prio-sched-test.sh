...
KERNEL_CMDLINE="boot-device=ata0 init=/usr/prio-sched-test pgalloc.debug=0 pgalloc.algorithm=simple objalloc.debug=0 sched.debug=0 sched.algorithm=cfs syslog=serial $*"
